...
test.describe('Process End Page', () => {
  test('End Page Tab', async ({ page }) => {
    await screenshotInscriptionTab(page, END_PID.PAGE, 'End Page', 'process-end-page-tab-end-page.png');
  });
});

test.describe('Error End', () => {
  test('Error Tab', async ({ page }) => {
    await screenshotInscriptionTab(page, END_PID.ERROR, 'Error', 'error-end-event-tab-error.png');
  });
});
